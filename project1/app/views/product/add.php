    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-gradient text-white py-3" style="background-color: #28a745;">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="/project1/Product/save" enctype="multipart/form-data" onsubmit="return validateForm();" class="needs-validation" novalidate>
                        <div class="row g-4">
                                ...
                                <div class="image-upload-container mb-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="image-upload-btn">
                                            <label for="image" class="btn btn-outline-success w-100">
                                                <i class="bi bi-upload me-1"></i><?php echo __('Chọn hình ảnh'); ?>
                                            </label>
                                            <input type="file" id="image" name="image" class="form-control d-none" accept="image/*">
                                        </div>
                                        
                                        <div id="removeImageBtn" class="mt-2" style="display:none;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" id="price" name="price" class="form-control" 
                                                   step="0.01" placeholder="<?php echo __('Giá (VND)'); ?>" required>
                                            <label for="price">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <select id="category_id" name="category_id" class="form-select" required>
                                                <option value="" disabled selected><?php echo __('Chọn danh mục'); ?></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" id="quantity" name="quantity" class="form-control"
                                                min="0" placeholder="<?php echo __('Số lượng'); ?>" required>
                                            <label for="quantity">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <textarea id="description" name="description" class="form-control" style="height: 150px;" 
                                                      placeholder="<?php echo __('Mô tả'); ?>" required></textarea>
                        ...
                        <div class="d-flex justify-content-center mt-4 gap-2">
                            <button type="submit" class="btn btn-success px-4 py-2">
                                <i class="bi bi-plus-circle me-2"></i><?php echo __('Thêm sản phẩm'); ?>
                            </button>
...
function removeImage() {
    ...
    document.querySelector('.current-image-container').style.display = 'flex';
